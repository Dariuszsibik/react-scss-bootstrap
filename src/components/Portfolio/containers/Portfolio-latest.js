            ...
            <div className="row">
                <div className="col">
                    <div className="ds-portfolio-box featured"
                        onMouseEnter={this.props.mouseEnter.bind(this, 1)}
                        onMouseLeave={this.props.mouseLeave.bind(this, 1)}
                    >
